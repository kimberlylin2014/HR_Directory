const userActionTypes = {
    ...
    UPDATE_PROFILEFORM_START: 'UPDATE_PROFILEFORM_START',
    UPDATE_PROFILEFORM_SUCCESS: 'UPDATE_PROFILEFORM_SUCCESS',
    UPDATE_PROFILEFORM_FAILURE: 'UPDATE_PROFILEFORM_FAILURE'
}
